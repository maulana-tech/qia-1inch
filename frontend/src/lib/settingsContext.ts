/**
 * Setelan tampilan: bahasa, mata uang, dan segala yang bukan komponen.
 *
 * # Kenapa terpisah dari `settings.tsx`
 *
 * Aturan `react-refresh/only-export-components` bukan rewel soal gaya. Vite
 * hanya bisa mengganti modul panas kalau berkasnya HANYA mengekspor komponen —
 * begitu ada ekspor lain di berkas yang sama, menyunting salah satu memaksa
 * muat ulang penuh, dan seluruh state aplikasi hilang: dompet terputus,
 * formulir kosong lagi.
 *
 * Jadi provider-nya tinggal sendirian di `settings.tsx`, dan semua yang bukan
 * komponen ada di sini.
 */
...
const en = {
  ...
  'settings.about': 'Iqia is a trading desk built on 1inch Aqua. Market makers keep their tokens in their own wallets.',
...
const id = {
  ...
  'settings.about': 'Iqia adalah meja dagang di atas 1inch Aqua. Market maker menyimpan tokennya di dompet sendiri.',
...
const vi = {
  ...
  'settings.about': 'Iqia là một bàn giao dịch trên 1inch Aqua. Nhà tạo lập thị trường giữ token trong ví của chính họ.',
...
const fil = {
  ...
  'settings.about': 'Ang Iqia ay isang trading desk na nakabatay sa 1inch Aqua. Ang mga market maker ay nagtatago ng kanilang token sa sarili nilang wallet.',
  'settings.byline': 'Iqia App',
  'settings.langEn': 'English',
  'settings.langId': 'Bahasa Indonesia',
  'settings.langVi': 'Tiếng Việt',
