...
const en = {
  ...
  'settings.networkTestnet': 'Flare Testnet',
  'settings.networkTestnetHint':
    'This app runs on Flare testnet. Funds here are for testing only and have no real value.',
...
const id = {
  ...
  'settings.networkTestnet': 'Flare Testnet',
  'settings.networkTestnetHint':
    'Aplikasi ini jalan di Flare testnet. Dana di sini cuma buat uji coba dan tidak bernilai sungguhan.',
...
const vi = {
  ...
  'settings.networkTestnet': 'Flare Testnet',
  'settings.networkTestnetHint':
    'Ứng dụng này chạy trên Flare testnet. Số tiền ở đây chỉ dùng để thử nghiệm và không có giá trị thật.',
...
const fil = {
  ...
  'settings.networkTestnet': 'Flare Testnet',
  'settings.networkTestnetHint':
    'Tumatakbo ang app na ito sa Flare testnet. Ang mga funds dito ay pantesting lang at walang totoong value.',
  'settings.contract': 'Contract',
